...
// Kept as the name this file's own tests and callers already use — see
// lib/idSetHistory.js for the shared implementation (also used by
// lib/frictionHistory.js's barrier-ID comparison; same rule, two domains).
export const compareOpportunitySets = compareIdSets;
