...
import { getScoreGoal, listScoreSnapshots, pickLatestScore, computeScorePath, SCORE_RECONFIRM_WINDOW_DAYS } from './creditScore';
import { listRecentEvents } from './events';
import { describeFact, FRESHNESS_STATES } from './factProvenance';
...
function computeRecommendation({
  ...
  hasGoalWithoutScore, scoreNeedsUpdate,
}) {
