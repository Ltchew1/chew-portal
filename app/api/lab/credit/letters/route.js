...
export async function POST(req) {
  ...
  try {
    ...
    if (err.message?.startsWith('All items') || err.message?.startsWith('A mailing address') || err.message?.startsWith('Some items') || err.message?.startsWith('This letter could not be generated')) {
